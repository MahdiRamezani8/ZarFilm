...
})({"drBuv":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "373279a9b01427ed";
"use strict";
...
},{}],"15HtN":[function(require,module,exports) {
var _initialJs = require("../initial.js");
var _dataJs = require("./data.js");
var _sliderJs = require("./slider.js");
var _categoryJs = require("./category.js");
...
(0, _categoryJs.categoryMaker)(animeGalleryEl, (0, _dataJs.popularAnimes), (0, _initialJs.API), (0, _initialJs.APIKey));
(0, _sliderJs.sliderMaker)(headerSliderEl, (0, _dataJs.popularSeriesAndMovies), (0, _initialJs.API), (0, _initialJs.APIKey)).then((order)=>(0, _domJs.mountSplide)(order));
(0, _sliderJs.sliderMaker)(firstMovieSliderEl, (0, _dataJs.firstMoviesList), (0, _initialJs.API), (0, _initialJs.APIKey));
(0, _sliderJs.sliderMaker)(secondMovieSliderEl, (0, _dataJs.secondMoviesList), (0, _initialJs.API), (0, _initialJs.APIKey));

},{"./data.js":"8eRYu","../initial.js":"eWEst","./slider.js":"g6u2M","./category.js":"6mRwv","./dom.js":"1p8Jy"}],"8eRYu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "firstMoviesList", ()=>firstMoviesList);
parcelHelpers.export(exports, "secondMoviesList", ()=>secondMoviesList);
parcelHelpers.export(exports, "popularAnimes", ()=>popularAnimes);
parcelHelpers.export(exports, "popularSeriesAndMovies", ()=>popularSeriesAndMovies);
const firstMoviesList = [
    "fight club",
    "The Pianist",
    "taxi driver",
    "home alone",
...
},{}],"eWEst":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const navigationHTML = `
    <nav class="navigation">
      <img src="${require("986e1c2dbb09159a")}" alt="logo" />
      <ul class="menu">
        <li><a href="">\u{62F}\u{633}\u{62A}\u{647} \u{628}\u{646}\u{62F}\u{6CC}</a></li>
        <li><a href="">\u{647}\u{646}\u{631}\u{645}\u{646}\u{62F}\u{627}\u{646}</a></li>
        <li><a href="">\u{67E}\u{62E}\u{634} \u{622}\u{646}\u{644}\u{627}\u{6CC}\u{646}</a></li>
        <li><a href="">\u{62E}\u{631}\u{6CC}\u{62F} \u{627}\u{634}\u{62A}\u{631}\u{627}\u{6A9}</a></li>
      </ul>
      ...
      <div class="search-box">
        <input
          type="text"
          class="search-input"
          placeholder="\u{646}\u{627}\u{645} \u{631}\u{627} \u{648}\u{627}\u{631}\u{62F} \u{6A9}\u{646}\u{6CC}\u{62F}..."
        />
      ...
      <button class="btn">\u{648}\u{631}\u{648}\u{62F}/\u{639}\u{636}\u{648}\u{6CC}\u{62A}</button>
    </nav>
`;
const footerHTML = `
    <footer class="footer">
        <header class="head">
         <button class="goUp"><i class="fa-solid fa-angle-up"></i></button>
          <ul class="list">
            <li class="item"><a href="#">\u{62E}\u{631}\u{6CC}\u{62F} \u{627}\u{634}\u{62A}\u{631}\u{627}\u{6A9}</a></li>
            <li class="item"><a href="#">\u{67E}\u{62E}\u{634} \u{622}\u{646}\u{644}\u{627}\u{6CC}\u{646}</a></li>
            <li class="item"><a href="#">\u{633}\u{648}\u{627}\u{644}\u{627}\u{62A} \u{645}\u{62A}\u{62F}\u{627}\u{648}\u{644}</a></li>
            <li class="item"><a href="#">\u{642}\u{648}\u{627}\u{646}\u{6CC}\u{646}</a></li>
            <li class="item"><a href="#">\u{62A}\u{645}\u{627}\u{633} \u{628}\u{627} \u{645}\u{627}</a></li>
         </ul>
         <div class="icons">
            <a href="">
          ...
          <a class="download-btn">\u{62F}\u{627}\u{646}\u{644}\u{648}\u{62F} \u{627}\u{67E}\u{644}\u{6CC}\u{6A9}\u{6CC}\u{634}\u{646} <i class="fa-brands fa-android"></i></a>
        </header>
        <p>
...
function handleBlurNavigation([{ isIntersecting }]) {
    !isIntersecting ? navigationEl.classList.add("blur") : navigationEl.classList.remove("blur");
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","986e1c2dbb09159a":"hgrXZ"}],"hgrXZ":[function(require,module,exports) {
module.exports = require("23c9de1156f7e7e0").getBundleURL("4JOq4") + "logo.c493797d.png" + "?" + Date.now();

},{"23c9de1156f7e7e0":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"g6u2M":[function(require,module,exports) {
// A function to create a slider of movies from an array of titles
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sliderMaker", ()=>sliderMaker);
async function sliderMaker(el, arr, API, APIkey) {
    // An array to store the order of movies
    const orderOfMovies = [];
    // Loop through the array of titles
    for (const m of arr)try {
        // Fetch the movie data from the API
        const response = await fetch(`${API}?t=${m.replaceAll(" ", "+")}&apikey=${APIkey}`);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6mRwv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "categoryMaker", ()=>categoryMaker);
function categoryMaker(el, arr, API, APIkey) {
    arr.forEach(async (a)=>{
        try {
            const response = await fetch(`${API}?t=${a.replaceAll(" ", "+")}&apikey=${APIkey}`);
            if (!response.ok) throw new Error(response.ok);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1p8Jy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mountSplide", ()=>mountSplide);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["drBuv","15HtN"], "15HtN", "parcelRequireb378")

//# sourceMappingURL=index.b01427ed.js.map
